...
public class ProfesorView extends JPanel {
	...
	public ProfesorView() {
		...
		JLabel lblNewLabel_2 = new JLabel("GESTIÓN DE PROFESORES");
		...
		btnPrimerReg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Profesor p1 = ProfesorController.findFirst();
		...
		btnAnteriorReg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Profesor p = new Profesor(Integer.parseInt(jtfId.getText()), jtfNombre.getText(),
		...
		btnSiguienteReg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Profesor p = new Profesor(Integer.parseInt(jtfId.getText()), jtfNombre.getText(),
						jtfApellido1.getText(), jtfApellido2.getText(), jtfDni.getText(), jtfDireccion.getText(),
						jtfEmail.getText(), jtfTelefono.getText());
				Profesor p1 = ProfesorController.next(p);
				if (p1 != null) {
					jtfId.setText(String.valueOf(p1.getId()));
					jtfNombre.setText(p1.getNombre());
					jtfApellido1.setText(p1.getApellido1());
		...
		btnUltimoReg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Profesor p = new Profesor();
				Profesor p1 = ProfesorController.findLast();
				jtfId.setText(String.valueOf(p1.getId()));
				jtfNombre.setText(p1.getNombre());
				jtfApellido1.setText(p1.getApellido1());
				jtfApellido2.setText(p1.getApellido2());
		...
		btnNuevoReg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Profesor p = new Profesor(Integer.parseInt(jtfId.getText()), jtfNombre.getText(),
						jtfApellido1.getText(), jtfApellido2.getText(), jtfDni.getText(), jtfDireccion.getText(),
						jtfEmail.getText(), jtfTelefono.getText());
				ProfesorController.insert(jtfId, jtfNombre, jtfApellido1, jtfApellido2, jtfDni, jtfDireccion,
		...
		btnEditarReg.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Profesor p = new Profesor(Integer.parseInt(jtfId.getText()), jtfNombre.getText(),
						jtfApellido1.getText(), jtfApellido2.getText(), jtfDni.getText(), jtfDireccion.getText(),
						jtfEmail.getText(), jtfTelefono.getText());
				ProfesorController.delete(p, jtfId, jtfNombre, jtfApellido1, jtfApellido2, jtfDni, jtfDireccion,
						jtfEmail, jtfTelefono);
			}
		});
		...
		Profesor p = new Profesor();
		Profesor p1 = ProfesorController.loadFirst();
		jtfId.setText(String.valueOf(p1.getId()));
		jtfNombre.setText(p1.getNombre());
		jtfApellido1.setText(p1.getApellido1());
		jtfApellido2.setText(p1.getApellido2());
